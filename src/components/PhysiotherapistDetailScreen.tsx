...
const physiotherapistsData: Record<string, PhysiotherapistData> = {
  "dr-martin-son": {
    name: "Dr. Martin Son",
    ...
    homeRadius: "12",
    rating: 4,
    about: "Dr. Martin Son is a dedicated Physiotherapist with 5 years of specialized practice. He focuses on rehabilitation, pain management, and restoring mobility through evidence-based therapeutic techniques.",
    education: "BPT, MPT - Orthopedic Physiotherapy",
    specializations: "Sports Injury Rehabilitation, Manual Therapy, Post-operative Care, Chronic Pain Management",
    languages: "English, Telugu, Hindi",
    registration: "PT12345"
  },
  "dr-james-roy": {
    name: "Dr. James Roy",
    specialty: "Physiotherapist",
    ...
    homeRadius: "10",
    rating: 4,
    about: "Dr. James Roy is a skilled Physiotherapist with 3 years of focused experience. He specializes in musculoskeletal rehabilitation and uses modern therapeutic techniques to help patients regain strength and mobility.",
    education: "BPT, MPT - Neurology Physiotherapy",
    specializations: "Neurological Rehabilitation, Stroke Recovery, Balance Training, Geriatric Care",
    languages: "English, Hindi",
    registration: "PT23456"
  },
  "dr-matthew-christopher": {
    ...
    weekdaysTime: "7 AM - 5 PM",
    weekendsTime: "9 AM - 2 PM",
    inClinicCost: "150",
    homeCost: "200",
    homeRadius: "8",
    rating: 4,
    about: "Dr. Matthew Christopher is an enthusiastic Physiotherapist with 2 years of practice. He is passionate about helping patients recover from injuries and improving their quality of life through personalized treatment plans.",
    education: "BPT, MPT - Sports Physiotherapy",
    specializations: "Sports Medicine, Injury Prevention, Athletic Performance, Kinesiology",
    languages: "English, Telugu, Tamil",
    registration: "PT34567"
  },
  "dr-arun-kumar": {
    name: "Dr. Arun Kumar",
    specialty: "Physiotherapist",
    ...
    weekdaysTime: "8 AM - 8 PM",
    weekendsTime: "10 AM - 5 PM",
    inClinicCost: "250",
    homeCost: "300",
    homeRadius: "15",
    rating: 5,
    about: "Dr. Arun Kumar is a highly experienced Physiotherapist with 7 years of comprehensive practice. He has expertise in treating complex musculoskeletal conditions and has helped thousands of patients achieve optimal recovery.",
    education: "BPT, MPT - Orthopedic & Sports Physiotherapy",
    specializations: "Spinal Disorders, Joint Mobilization, Therapeutic Exercise, Postural Correction",
    languages: "English, Telugu, Hindi, Kannada",
    registration: "PT45678"
  },
  "dr-vikram-singh": {
    ...
    homeRadius: "12",
    rating: 4,
    about: "Dr. Vikram Singh is a compassionate Physiotherapist with 4 years of dedicated service. He specializes in pain management and functional rehabilitation, helping patients return to their daily activities with confidence.",
    education: "BPT, MPT - Cardio-Respiratory Physiotherapy",
    specializations: "Respiratory Care, Cardiac Rehabilitation, Pulmonary Therapy, Intensive Care Physiotherapy",
    languages: "English, Hindi, Punjabi, Telugu",
    registration: "PT56789"
  }
};

export default function PhysiotherapistDetailScreen() {
  const navigate = useNavigate();
  const { physiotherapistName } = useParams<{ physiotherapistName: string }>();
  
  const physiotherapist = physiotherapistName ? physiotherapistsData[physiotherapistName] : null;

  if (!physiotherapist) {
    return (
      <div className="bg-white relative w-full min-h-screen max-w-[393px] mx-auto flex items-center justify-center">
        <p className="font-['Poppins:Medium',sans-serif] text-[16px] text-[#555]">Physiotherapist not found</p>
      </div>
    );
  }
      ...
      <div className="flex-1 overflow-y-auto" style={{
        ...
        <div className="px-[16px] pt-[16px] pb-[120px]">
          ...
          <div className="h-[260px] relative rounded-[16px] shadow-[0px_4px_12px_0px_rgba(0,0,0,0.15)] shrink-0 w-full overflow-hidden mb-[16px]">
            <img alt={physiotherapist.name} className="object-cover size-full" style={{ objectPosition: '50% 20%' }} src={physiotherapist.image} />
          </div>
              ...
              <div className="box-border content-stretch flex flex-col gap-[6px] p-[16px] relative w-full">
                <div className="flex items-start justify-between w-full gap-[10px]">
                  <div className="flex flex-col gap-[4px]">
                    <p className="font-['Poppins:Bold',sans-serif] text-[18px] text-white leading-tight drop-shadow-[0_1px_2px_rgba(0,0,0,0.2)]">{physiotherapist.name}</p>
                    <p className="font-['Poppins:Medium',sans-serif] text-[13px] text-white/90 leading-tight">{physiotherapist.specialty}</p>
                  </div>
                    ...
                    {Array.from({ length: 5 }).map((_, i) => (
                      <svg key={i} className="size-[13px]" fill="none" viewBox="0 0 24 24">
                        <path 
                          ...
                          fill={i < physiotherapist.rating ? "#FFD700" : "#white"} 
                          fillOpacity={i < physiotherapist.rating ? 1 : 0.5}
                        />
                      </svg>
                    ))}
                  </div>
            ...
            <div className="flex flex-col gap-[12px]">
              ...
              <div className="flex items-center gap-[10px] bg-white rounded-[10px] p-[12px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.05)]">
                ...
                <div className="flex flex-col gap-[2px]">
                  ...
                  <p className="font-['Poppins:Medium',sans-serif] text-[13px] text-[#121314] leading-tight">{physiotherapist.location}</p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-[8px] bg-white rounded-[10px] p-[12px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.05)]">
                ...
                <div className="flex items-center justify-between bg-gradient-to-r from-[#f0fdf4] to-[#dcfce7] rounded-[8px] px-[12px] py-[8px] border border-[#86efac]">
                  ...
                  <p className="font-['Poppins:Bold',sans-serif] text-[12px] text-[#10b981] leading-tight">{physiotherapist.weekdaysTime}</p>
                </div>
                ...
                <div className="flex items-center justify-between bg-gradient-to-r from-[#fef3c7] to-[#fde68a] rounded-[8px] px-[12px] py-[8px] border border-[#fcd34d]">
                  ...
                  <p className="font-['Poppins:Bold',sans-serif] text-[12px] text-[#f59e0b] leading-tight">{physiotherapist.weekendsTime}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="content-stretch flex gap-[10px] items-center leading-[0] relative shrink-0 w-full px-[0px] mb-[14px]">
            <div className="flex-1 bg-gradient-to-br from-[#5379df] to-[#4268ce] h-[54px] rounded-[12px] flex items-center justify-center px-[8px] shadow-[0px_4px_10px_0px_rgba(83,121,223,0.4)] border-2 border-white/20">
              <div className="flex flex-col items-center gap-[2px]">
                <p className="font-['Poppins:ExtraBold',sans-serif] text-[16px] text-center text-white leading-tight drop-shadow-[0_1px_2px_rgba(0,0,0,0.2)]">{physiotherapist.experience}</p>
            ...
            <div className="flex-1 bg-gradient-to-br from-[#74c4f7] to-[#5ab3e6] h-[54px] rounded-[12px] flex items-center justify-center px-[8px] shadow-[0px_4px_10px_0px_rgba(116,196,247,0.4)] border-2 border-white/20">
              <div className="flex flex-col items-center gap-[2px]">
                <p className="font-['Poppins:ExtraBold',sans-serif] text-[16px] text-center text-white leading-tight drop-shadow-[0_1px_2px_rgba(0,0,0,0.2)]">{physiotherapist.patients}</p>
            ...
            <div className="bg-white rounded-[10px] p-[12px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.05)] flex flex-col gap-[6px]">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-[4px]">
                  ...
                  <p className="font-['Poppins:SemiBold',sans-serif] text-[14px] text-black leading-tight">{physiotherapist.inClinicCost}</p>
                </div>
              </div>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-[4px]">
                  ...
                  <p className="font-['Poppins:SemiBold',sans-serif] text-[14px] text-black leading-tight">{physiotherapist.homeCost}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-[10px] relative shrink-0 w-full px-[0px] bg-gradient-to-br from-[#fff8f5] to-[#ffeee5] rounded-[14px] p-[16px] shadow-[0px_4px_10px_0px_rgba(179,38,30,0.15)] border-2 border-[#ffe5dd] mb-[12px]">
            ...
            <div className="bg-white rounded-[10px] p-[12px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.05)]">
              <p className="font-['Poppins:Medium',sans-serif] text-[12px] text-[#555] pl-[0px] leading-relaxed">{`Home consults available within ${physiotherapist.homeRadius} Km Radius`}</p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-[10px] relative shrink-0 w-full px-[0px] bg-gradient-to-br from-[#f0fdf4] to-[#dcfce7] rounded-[14px] p-[16px] shadow-[0px_4px_10px_0px_rgba(16,185,129,0.15)] border-2 border-[#86efac] mb-[12px]">
            <div className="flex items-center gap-[8px]">
              ...
              <p className="font-['Poppins:Bold',sans-serif] text-[15px] text-[#10b981] leading-tight">{`About Physiotherapist`}</p>
            </div>
              ...
              <div className="flex flex-col gap-[8px]">
                <div className="flex items-start gap-[8px]">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-['Poppins:Regular',sans-serif] text-[11px] text-[#555] leading-relaxed">{physiotherapist.education}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-[8px]">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-['Poppins:Regular',sans-serif] text-[11px] text-[#555] leading-relaxed">{physiotherapist.specializations}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-[8px]">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-['Poppins:Regular',sans-serif] text-[11px] text-[#555] leading-relaxed">{physiotherapist.languages}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-[8px]">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-['Poppins:Regular',sans-serif] text-[11px] text-[#555] leading-relaxed">Physiotherapy Council Registration No: {physiotherapist.registration}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Book Now Button */}
          <button
            onClick={() => navigate(`/physiotherapists/${physiotherapistName}/book`, { state: { physiotherapist } })}
