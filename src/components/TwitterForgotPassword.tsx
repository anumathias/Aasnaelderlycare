...
export default function TwitterForgotPassword() {
          ...
          {step === "email" ? (
            <>
              ...
              <button
                ...
                className="w-full bg-[#1DA1F2] hover:bg-[#1a91da] transition-colors rounded-lg h-12 flex items-center justify-center text-white"
              >
