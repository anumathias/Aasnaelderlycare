  ...
  const medicines = [
    {
      ...
      uses: "Overall health, Energy boost, Immune support, Bone health",
    ...
    },
    {
      ...
      uses: "Bone strength, Calcium absorption, Immune function, Mood support",
    ...
    },
    {
      ...
      uses: "Heart health, Brain function, Joint support, Eye health",
    ...
    },
    {
      ...
      uses: "Energy production, Nervous system, Red blood cells, Stress management",
    ...
    },
    {
      ...
      price: "₹220",
      description: "Calcium carbonate with vitamin D3 for optimal bone health",
      uses: "Bone density, Osteoporosis prevention, Dental health, Muscle function",
    ...
    },
    {
      ...
      uses: "Immune system, Antioxidant, Collagen production, Wound healing",
      dosage: "1 tablet daily",
      prescription: "Not Required"
    }
  ];
  ...
  return (
    <div className="bg-gradient-to-b from-[#f8f9fa] to-white min-h-screen w-full max-w-[393px] mx-auto relative pb-[120px] overflow-y-auto">
      ...
      <div className="px-[16px] pt-[16px]">
        ...
        <div className="flex items-center justify-between mb-[20px]">
          ...
          <div className="flex items-center gap-[12px]">
            <svg className="size-[28px]" fill="none" viewBox="0 0 24 24">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5 11h-4v4h-2v-4H7v-2h4V7h2v4h4v2z" fill="#48A2E8" />
            </svg>
        ...
        {/* Category Header */}
        <div className="bg-gradient-to-r from-[#48A2E8] to-[#66b3ed] rounded-[16px] p-[20px] mb-[20px] shadow-md">
          <div className="flex items-center gap-[16px]">
            ...
            <div>
              ...
              <p className="font-['Poppins:Regular',sans-serif] text-[13px] text-white/90 leading-snug">
                Boost well-being with daily essentials
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-[12px]">
                <div className="flex items-start gap-[12px] flex-1">
                  {/* Medicine Icon */}
                  <div className="shrink-0 size-[50px] bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-full flex items-center justify-center border border-cyan-200">
                    <svg className="size-[28px]" fill="none" viewBox="0 0 24 24">
                      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5 11h-4v4h-2v-4H7v-2h4V7h2v4h4v2z" fill="#48A2E8" />
                    </svg>
                  </div>
              ...
              <div className="space-y-[8px] mb-[12px]">
                ...
                <div className="flex items-start gap-[8px]">
                  ...
                  <p className="font-['Poppins:Medium',sans-serif] text-[12px] text-[#10b981] leading-relaxed">
