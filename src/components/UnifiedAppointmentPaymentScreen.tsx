...
export function UnifiedAppointmentPaymentScreen() {
        ...
        <div className="bg-[#f9fafb] border border-[#e5e7eb] rounded-[12px] p-[16px] mb-[24px]">
          ...
          <div className="space-y-[8px]">
            ...
            <div className="flex justify-between">
              ...
              <p className="font-['Poppins:Regular',sans-serif] text-[13px] text-[#121314]">
                {appointmentDetails.appointmentType === "in-person" ? "In-Person" : 
                 appointmentDetails.appointmentType === "home" ? "Home Visit" :
                 appointmentDetails.serviceType === "full-time" ? "Full-Time Service" :
                 appointmentDetails.serviceType === "part-time" ? "Part-Time Service" : "Service"}
              </p>
            </div>
      ...
      <div className="fixed bottom-[80px] left-0 right-0 bg-white border-t border-[#e5e7eb] px-[16px] py-[14px] max-w-[393px] mx-auto w-full z-50">
        <div className="flex items-center justify-between mb-[10px]">
          <p className="font-['Poppins:Regular',sans-serif] text-[12px] text-[#5f6368]">
            {appointmentDetails.serviceType ? "Service Fee" : "Consultation Fee"}
          </p>
