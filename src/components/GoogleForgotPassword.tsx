...
export default function GoogleForgotPassword() {
          ...
          {step === "email" ? (
            <>
              ...
              <button
                ...
                className="w-full bg-[#4285F4] hover:bg-[#357ae8] transition-colors rounded-lg h-12 flex items-center justify-center text-white"
              >
