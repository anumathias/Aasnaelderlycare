      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="flex justify-center mb-6">
            <div className="size-16">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 43 40">
                <g>
                  <path d={svgPaths.p2a2c9380} fill="#1DA1F2" stroke="#1DA1F2" />
                </g>
              </svg>
            </div>
          </div>
          ...
          <div className="text-center mb-6">
            <h1 className="text-2xl mb-2">Sign in to Twitter</h1>
          </div>
          ...
          <div className="space-y-4 mb-4">
            ...
            <div className="bg-white h-14 relative rounded-lg shrink-0 w-full group">
              ...
              <div aria-hidden="true" className="absolute border border-gray-300 border-solid inset-[-0.5px] pointer-events-none rounded-lg group-focus-within:border-[#1DA1F2] group-focus-within:border-2 transition-all" />
            </div>
          ...
          <button
            ...
            className="w-full bg-[#1DA1F2] hover:bg-[#1a91da] transition-colors rounded-lg h-12 flex items-center justify-center text-white mb-4"
          >
            Log in
          </button>
          ...
          <div className="text-center mb-4">
            <span 
              onClick={() => navigate("/forgot-password/twitter")}
              className="text-[#1DA1F2] text-sm cursor-pointer hover:underline"
            >
              Forgot password?
            </span>
          </div>
          ...
          <div className="text-center">
            <button className="text-[#1DA1F2] hover:underline">
              Sign up for Twitter
            </button>
          </div>
        </div>
