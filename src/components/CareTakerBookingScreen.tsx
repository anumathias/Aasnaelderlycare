...
export function CareTakerBookingScreen() {
  ...
  const [serviceType, setServiceType] = useState<"full-time" | "part-time" | null>(null);
  ...
  const handleProceedToPayment = () => {
    if (!selectedDate || !selectedTime || !serviceType) {
      alert("Please select date, time, and service type");
      return;
    }
    ...
    navigate("/caretaker-appointment-payment", {
      state: {
        careTakerName: careTaker.name,
        specialty: careTaker.specialty || "CareTaker",
        date: selectedDate,
        time: selectedTime,
        serviceType: serviceType,
        location: locationDetails,
        amount: serviceType === "full-time" ? careTaker.fullTimeCost || "800" : careTaker.partTimeCost || "400"
      }
    });
  };
    ...
    <div className="relative flex flex-col items-center min-h-screen w-full max-w-[393px] mx-auto bg-white overflow-y-auto">
      ...
      <div className="flex-1 w-full px-[16px] py-[20px] pb-[200px]">
        ...
        <div className="bg-[#f9fafb] border border-[#e5e7eb] rounded-[12px] p-[14px] mb-[24px] flex items-center gap-[12px]">
          <div className="size-[60px] rounded-full bg-[#1F75BE]/10 flex items-center justify-center flex-shrink-0">
            <p className="font-['Poppins:SemiBold',sans-serif] text-[20px] text-[#1F75BE]">
              {careTaker.name?.charAt(0) || "C"}
            </p>
          </div>
          <div>
            ...
            <p className="font-['Poppins:Regular',sans-serif] text-[13px] text-[#5f6368]">
              {careTaker.specialty || "Professional CareTaker"}
            </p>
          </div>
        </div>
        ...
        <div className="mb-[24px]">
          ...
          <div className="grid grid-cols-2 gap-[12px]">
            <button
              onClick={() => setServiceType("full-time")}
            ...
            >
              <p className={`font-['Poppins:SemiBold',sans-serif] text-[14px] mb-[4px] ${
                serviceType === "full-time" ? "text-[#1F75BE]" : "text-[#121314]"
              }`}>
                Full-Time
              </p>
            ...
            <button
              onClick={() => setServiceType("part-time")}
              className={`p-[16px] rounded-[12px] border-2 transition-all ${
            ...
            >
              <p className={`font-['Poppins:SemiBold',sans-serif] text-[14px] mb-[4px] ${
                serviceType === "part-time" ? "text-[#1F75BE]" : "text-[#121314]"
              }`}>
                Part-Time
              </p>
              <p className="font-['Poppins:Regular',sans-serif] text-[12px] text-[#5f6368]">
      ...
      <div className="fixed bottom-[80px] left-0 right-0 bg-white border-t border-[#e5e7eb] px-[16px] py-[14px] max-w-[393px] mx-auto w-full z-50">
        <div className="flex items-center justify-between mb-[10px]">
          ...
          <p className="font-['Poppins:SemiBold',sans-serif] text-[18px] text-[#1F75BE]">
            ₹{serviceType === "full-time" ? careTaker.fullTimeCost || "800" : careTaker.partTimeCost || "400"}
          </p>
        </div>
        <button
          ...
          disabled={!selectedDate || !selectedTime || !serviceType || (!selectedLocation && !newLocation)}
        >
          Proceed to Payment
        </button>
      </div>
