...
import svgPaths from "../imports/svg-8wx62m7m25";
...
const doctorsData: Record<string, DoctorData> = {
  "dr-mary-lawson": {
    ...
    homeRadius: "10",
    rating: 4,
    about: "Dr. Mary Lawson is a highly experienced General Specialist with over 5 years of dedicated practice. She specializes in comprehensive healthcare and preventive medicine.",
  ...
  "dr-john-harry": {
    ...
    weekdaysTime: "8 AM - 5 PM",
    weekendsTime: "10 AM - 3 PM",
    inClinicCost: "300",
    homeCost: "400",
    homeRadius: "8",
    rating: 4,
    about: "Dr. John Harry is a skilled Cardiologist Specialist with 3 years of focused practice. He specializes in cardiovascular health and preventive cardiology.",
    education: "MBBS, MD - Cardiology",
    specializations: "Heart Disease, Preventive Cardiology, ECG Analysis",
  ...
  "dr-eddy-munson": {
    ...
    weekendsTime: "12 PM - 5 PM",
    inClinicCost: "500",
    homeCost: "650",
    homeRadius: "15",
    rating: 5,
    about: "Dr. Eddy Munson is a highly experienced Neurologist Specialist with over 13 years of dedicated practice. He specializes in brain and nervous system disorders with advanced diagnostic expertise.",
    education: "MBBS, MD - Neurology, DM - Neurology",
    specializations: "Stroke, Epilepsy, Migraine, Parkinson's Disease",
  ...
  "dr-priya-sharma": {
    ...
    homeRadius: "12",
    rating: 5,
    about: "Dr. Priya Sharma is a compassionate Pediatrician Specialist with 8 years of experience. She specializes in child healthcare, vaccinations, and developmental monitoring.",
    education: "MBBS, MD - Pediatrics",
    specializations: "Child Healthcare, Vaccinations, Growth Monitoring, Newborn Care",
  ...
  "dr-arjun-patel": {
    ...
    weekdaysTime: "8 AM - 7 PM",
    weekendsTime: "9 AM - 4 PM",
    inClinicCost: "450",
    homeCost: "600",
    homeRadius: "10",
    rating: 5,
    about: "Dr. Arjun Patel is an expert Orthopedic Specialist with 12 years of extensive experience. He specializes in bone, joint, and musculoskeletal conditions with advanced surgical expertise.",
    education: "MBBS, MS - Orthopedics",
    specializations: "Joint Replacement, Sports Injuries, Arthritis, Fracture Care",
  ...
  "dr-rajesh-kumar": {
    ...
    weekdaysTime: "9 AM - 8 PM",
    weekendsTime: "10 AM - 5 PM",
    inClinicCost: "400",
    homeCost: "550",
    homeRadius: "15",
    rating: 5,
    about: "Dr. Rajesh Kumar is a veteran ENT Specialist with 18 years of comprehensive practice. He specializes in ear, nose, and throat conditions with advanced microsurgical expertise.",
    education: "MBBS, MS - ENT",
    specializations: "Sinus Surgery, Hearing Loss, Throat Disorders, Allergy Treatment",
    ...
    <div className="bg-white relative w-full min-h-screen max-w-[393px] mx-auto flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto" style={{
        ...
        <div className="px-[16px] pt-[16px] pb-[120px]">
              ...
              <div className="box-border content-stretch flex flex-col gap-[6px] p-[16px] relative w-full">
                <div className="flex items-start justify-between w-full gap-[10px]">
                  <div className="flex flex-col gap-[4px]">
                    ...
                    <p className="font-['Poppins:Medium',sans-serif] text-[13px] text-white/90 leading-tight">{doctor.specialty}</p>
                  </div>
          ...
          {/* Book Now Button */}
          <div 
            onClick={() => navigate(`/doctors/${doctorName}/book`)}
