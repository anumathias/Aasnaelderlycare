import svgPaths from "./svg-gkqk1u9on6";
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start leading-[normal] not-italic relative shrink-0 text-white w-full">
      <p className="font-['Poppins:Medium',sans-serif] relative shrink-0 text-[24px] w-full">{`Dr . Martin Son `}</p>
      <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[20px] w-full">Physiotherapist</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="basis-0 content-stretch flex flex-col font-['Poppins:Medium',sans-serif] gap-[10px] grow items-start leading-[normal] min-h-px min-w-px not-italic relative shrink-0 text-[16px] text-white">
      ...
      <p className="relative shrink-0 w-full">{`500K `}</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="basis-0 bg-[#c59396] grow h-[200px] min-h-px min-w-px relative shrink-0">
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start leading-[normal] not-italic relative shrink-0 text-white w-full">
      <p className="font-['Poppins:Medium',sans-serif] relative shrink-0 text-[24px] w-full">{`Dr . James Roy `}</p>
      <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[20px] w-full">Physiotherapist</p>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="basis-0 content-stretch flex flex-col font-['Poppins:Medium',sans-serif] gap-[10px] grow items-start leading-[normal] min-h-px min-w-px not-italic relative shrink-0 text-[16px] text-white">
      ...
      <p className="relative shrink-0 tracking-[0.16px] w-full">1.5K</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="basis-0 bg-[#e8a9ad] grow h-[200px] min-h-px min-w-px relative shrink-0">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[30px] h-[200px] items-start p-[24px] relative w-full">
          <Frame5 />
          <Frame8 />
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start leading-[normal] not-italic relative shrink-0 text-white w-full">
      <p className="font-['Poppins:Medium',sans-serif] relative shrink-0 text-[24px] w-full">{`Dr . Matthew Christopher `}</p>
      <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[20px] w-full">Physiotherapist</p>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[10px] grow items-start leading-[normal] min-h-px min-w-px not-italic relative shrink-0 text-[16px] text-white">
      <p className="font-['Poppins:SemiBold',sans-serif] relative shrink-0 w-full">{`Experience `}</p>
      <p className="font-['Poppins:Medium',sans-serif] relative shrink-0 w-full">{`2 Years `}</p>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="basis-0 content-stretch flex flex-col font-['Poppins:Medium',sans-serif] gap-[10px] grow items-start leading-[normal] min-h-px min-w-px not-italic relative shrink-0 text-[16px] text-white">
      ...
      <p className="relative shrink-0 tracking-[0.16px] w-full">1.2K</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute content-stretch flex flex-col gap-[32px] items-center justify-center left-[11px] top-[304px] w-[559px]">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#066abf] text-[32px] text-center tracking-[0.1px] w-full">
        <p className="leading-[20px]">Physiotherapist</p>
      </div>
...
export default function PhysiotherapistScreen() {
  return (
    <div className="bg-white relative size-full" data-name="physiotherapist screen">
      <Group2 />
      <SearchBar />
