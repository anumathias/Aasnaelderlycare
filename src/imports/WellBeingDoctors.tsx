import svgPaths from "./svg-zt8gu86xnh";
...
function SearchBar() {
  return (
    <div className="absolute bg-[#ece6f0] h-[56px] left-[15px] max-w-[720px] rounded-[28px] top-[167px] w-[553px]" data-name="Search bar">
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start leading-[normal] not-italic relative shrink-0 text-white w-full">
      <p className="font-['Poppins:Medium',sans-serif] relative shrink-0 text-[24px] w-full">Dr. Evelyn Reed</p>
      <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[20px] w-full">Geriatric Psychiatrist</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[10px] grow items-start leading-[normal] min-h-px min-w-px not-italic relative shrink-0 text-[16px] text-white">
      <p className="font-['Poppins:SemiBold',sans-serif] relative shrink-0 w-full">{`Experience `}</p>
      <p className="font-['Poppins:Medium',sans-serif] relative shrink-0 w-full">{`7 Years `}</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="basis-0 content-stretch flex flex-col font-['Poppins:Medium',sans-serif] gap-[10px] grow items-start leading-[normal] min-h-px min-w-px not-italic relative shrink-0 text-[16px] text-white">
      <p className="relative shrink-0 w-full">
        <span className="font-['Poppins:SemiBold',sans-serif] not-italic">Patients</span>{" "}
      </p>
      <p className="relative shrink-0 w-full">{`120k `}</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="basis-0 bg-[#696fc7] grow h-[200px] min-h-px min-w-px relative shrink-0">
...
function PhysiotherapistMainComponent() {
  return (
    <div className="content-stretch flex h-[185px] items-end overflow-clip relative rounded-[16px] shrink-0 w-full" data-name="physiotherapist main component">
      <Frame4 />
      <div className="h-[185px] relative shrink-0 w-[193px]">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          <div className="absolute bg-white inset-0" />
          <div className="absolute inset-0 overflow-hidden">
            <img alt="" className="absolute h-[156.57%] left-[1.62%] max-w-none top-[-5.44%] w-full" src={imgRectangle832} />
          </div>
        </div>
      </div>
      <ShapeSet />
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start leading-[normal] not-italic relative shrink-0 text-white w-full">
      <p className="font-['Poppins:Medium',sans-serif] relative shrink-0 text-[24px] w-full">Dr. Arthur Miller</p>
      <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[20px] w-full">Clinical Psychologist</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[10px] grow items-start leading-[normal] min-h-px min-w-px not-italic relative shrink-0 text-[16px] text-white">
      <p className="font-['Poppins:SemiBold',sans-serif] relative shrink-0 w-full">{`Experience `}</p>
      <p className="font-['Poppins:Medium',sans-serif] relative shrink-0 w-full">{`20 Years `}</p>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="basis-0 content-stretch flex flex-col font-['Poppins:Medium',sans-serif] gap-[10px] grow items-start leading-[normal] min-h-px min-w-px not-italic relative shrink-0 text-[16px] text-white">
      ...
      <p className="relative shrink-0 tracking-[0.16px] w-full">5000k</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="basis-0 bg-[#a7aae1] grow h-[200px] min-h-px min-w-px relative shrink-0">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[30px] h-[200px] items-start p-[24px] relative w-full">
          <Frame5 />
          <Frame8 />
...
function PhysiotherapistMainComponent1() {
  return (
    <div className="content-stretch flex h-[185px] items-end overflow-clip relative rounded-[16px] shrink-0 w-full" data-name="physiotherapist main component">
      <Frame9 />
      <div className="h-[185px] relative shrink-0 w-[193px]">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          <div className="absolute bg-white inset-0" />
          <div className="absolute inset-0 overflow-hidden">
            <img alt="" className="absolute h-[156.49%] left-[0.81%] max-w-none top-[-11.32%] w-full" src={imgRectangle833} />
          </div>
        </div>
      </div>
      <ShapeSet1 />
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start leading-[normal] not-italic relative shrink-0 text-white w-full">
      <p className="font-['Poppins:Medium',sans-serif] relative shrink-0 text-[24px] w-full">Dr. Louis Chang</p>
      <p className="font-['Poppins:Regular',sans-serif] relative shrink-0 text-[20px] w-full">Cognitive Behavioral Therapist</p>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[10px] grow items-start leading-[normal] min-h-px min-w-px not-italic relative shrink-0 text-[16px] text-white">
      <p className="font-['Poppins:SemiBold',sans-serif] relative shrink-0 w-full">{`Experience `}</p>
      <p className="font-['Poppins:Medium',sans-serif] relative shrink-0 w-full">{`15 Years `}</p>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="basis-0 content-stretch flex flex-col font-['Poppins:Medium',sans-serif] gap-[10px] grow items-start leading-[normal] min-h-px min-w-px not-italic relative shrink-0 text-[16px] text-white">
      ...
      <p className="relative shrink-0 tracking-[0.16px] w-full">4000K</p>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="basis-0 bg-[#d59fd2] grow h-[200px] min-h-px min-w-px relative shrink-0">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[30px] h-[200px] items-start p-[24px] relative w-full">
          <Frame10 />
          <Frame13 />
...
function PhysiotherapistMainComponent2() {
  return (
    <div className="content-stretch flex h-[185px] items-end overflow-clip relative rounded-[16px] shrink-0 w-full" data-name="physiotherapist main component">
      <Frame14 />
      <div className="h-[185px] relative shrink-0 w-[193px]">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
          <div className="absolute bg-white inset-0" />
          <div className="absolute inset-0 overflow-hidden">
            <img alt="" className="absolute h-[156.49%] left-[-0.81%] max-w-none top-[-8.78%] w-full" src={imgRectangle834} />
          </div>
        </div>
      </div>
      <ShapeSet2 />
...
function Frame16() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[32px] items-center justify-center left-[11px] top-[304px] w-[559px]">
      <div className="flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#066abf] text-[32px] text-center tracking-[0.1px] w-full">
        <p className="leading-[20px]">Psychiatrists</p>
      </div>
      <PhysiotherapistMainComponent />
      <PhysiotherapistMainComponent1 />
      <PhysiotherapistMainComponent2 />
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="absolute box-border content-stretch flex gap-[12px] items-center left-[calc(50%+86px)] p-[16px] top-[39px]">
...
function NameComponent() {
  return (
    <div className="absolute box-border content-stretch flex gap-[12px] items-center left-[18px] p-[16px] top-[39px] w-[183px]" data-name="Name Component">
      <Component3DAvatars />
      <Group1 />
    </div>
  );
...
function IconButtonStandard() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[15px] size-[48px] top-[292px]" data-name="Icon button - standard">
      <Content2 />
    </div>
  );
}
...
export default function WellBeingDoctors() {
  return (
    <div className="bg-white relative size-full" data-name="well being Doctors">
      <Group2 />
      <SearchBar />
